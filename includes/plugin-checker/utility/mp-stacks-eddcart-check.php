...
*/
if (!function_exists('mp_stacks_eddcart_plugin_check')){
	function mp_stacks_eddcart_plugin_check( $plugins ) {
		
		$add_plugins = array(
			array(
				'plugin_name' => 'MP Stacks + EddCart',
				'plugin_message' => __('You require the MP Stacks + EddCart plugin. Install it here.', 'mp_stacks_eddcart'),
				'plugin_filename' => 'mp-stacks-eddcart.php',
				'plugin_download_link' => 'http://mintplugins.com/repo/mp-stacks-eddcart/?downloadfile=true',
...
add_filter( 'mp_core_check_plugins', 'mp_stacks_eddcart_plugin_check' );